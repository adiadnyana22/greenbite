        ...
        <div class="container mx-auto">
            <div>
                <div class="flex justify-between items-center mb-8">
                    <h1 class="text-5xl font-bold"><span class="text-primary">Green</span>Article</h1>
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <a href="{{ route('newsDetail', $news->id) }}" class="flex justify-start items-center rounded-lg shadow-lg gap-8 p-8">
                        <img src="{{ asset('assets/user/images/news/'.$news->image) }}" alt="{{ $news->name }}" class="basis-3/12 w-3/12 h-48 rounded object-cover">
