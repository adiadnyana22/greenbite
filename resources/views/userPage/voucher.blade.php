    ...
    <section class="pt-[175px] pb-16">
        <div class="container mx-auto">
            <div class="flex gap-8 my-3 items-start">
                <ul class="sticky flex flex-col px-8 gap-6 w-80">
                    <li><a href="{{ route('profile') }}" class="text-gray-400 text-lg block px-4 py-2 rounded transition hover:bg-primary hover:text-white">Personal Info</a></li>
                    <hr>
                    <li><a href="{{ route('voucher') }}" class="text-white text-lg bg-primary block px-4 py-2 rounded transition hover:bg-primary hover:text-white">Voucher</a></li>
                </ul>
                <div class="w-full">
                    <h1 class="text-3xl font-bold mb-4">Voucher</h1>
                    <div class="shadow-lg rounded-lg px-12 py-8 grid grid-cols-2 gap-4">
