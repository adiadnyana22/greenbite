...
@section('content')
    ...
    <div class="w-screen bg-tertiary grid grid-cols-1 lg:grid-cols-2">
        ...
        <section class="px-3 sm:px-12">
            ...
            <div class="mt-3 mb-12 flex flex-col gap-4" x-data="data()" id="foodList">
        ...
        async function init() {
            ...
            if (navigator.geolocation) {
                navigator.geolocation.getCurrentPosition(async function(position) {
                    ...
                    const currLat = parseFloat(getCookie('latitude')) ?? position.coords.latitude;
                    const currLng = parseFloat(getCookie('longitude')) ?? position.coords.longitude;
                    ...
                    foodList.forEach((food) => {
                        ...
                        foodListContainer.insertAdjacentHTML('beforeend', 
                            `<a href="/food/${food.id}" class="bg-secondary rounded-lg">
                                <div class="flex bg-white rounded-lg shadow bg-white w-full">
                                    <div class="w-48 relative">
                                        <img src="assets/user/images/food/${food.food_category_id}${(food.id % 4 + 1)}.jpeg" alt="${food.name}" class="object-cover w-48 h-full rounded-lg">
                                    ...
                                    <div class="px-4 py-2 flex flex-col justify-between h-full w-full">
                                        ...
                                        <div class="flex justify-start items-center gap-4">
                                            <img src="assets/user/images/merchant/${food.mitra.logo}" alt="Merchant"  class="rounded-full h-8 w-8 object-contain border-2 border-primary">
                                            <div class="pr-4">
                                ...
                                <div class="flex items-center bg-secondary text-white rounded-b-lg px-3 py-1">
                                    ...
                                    <div class="grow flex justify-end items-center gap-2">
                                        <div class="line-through text-gray-400 text-sm mt-1">${new Intl.NumberFormat('en-US').format(food.normal_price)}</div>
